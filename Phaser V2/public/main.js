...
function preload() {
    ...
    game.load.image('ground', 'assets/GirderTile.png');
    ...
    game.load.spritesheet('gate', 'assets/Gate.png', 36, 36);
}
...
function create() {
    ...
    eLvPortal = portals.create(690, 298, 'gate');
    eLvPortal.scale.setTo(1.5,1.5);
    ...
    enemy = enemies.create(665, 320, 'enemy');
    enemy.health = 3;
    enemy.animations.add('left', [0,1], 6, true);
    enemy.animations.add('right', [3,2], 6, true);
...
function update() {
    ...
    var eHitPlatform = game.physics.arcade.collide(enemies, platforms);
    game.physics.arcade.collide(stars, platforms);
    game.physics.arcade.overlap(player, enemies, hit, null, this);
    game.physics.arcade.overlap(shurikens, enemies, hit2, null, this);
